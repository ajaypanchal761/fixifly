  ...
  return (
    <section className="relative flex items-center justify-center min-h-[96vh] sm:min-h-[106vh]">
      ...
      <div className={`container mx-auto px-4 sm:px-6 lg:px-8 ${showMoreProducts ? 'mt-16 sm:pt-20 lg:pt-28' : 'mt-1 sm:pt-5 lg:pt-10'}`}>
        ...
        <div className={`relative animate-fade-in-delay order-1 lg:order-2 lg:absolute lg:right-0 lg:top-80 lg:transform lg:-translate-y-1/2 lg:w-1/2 lg:pr-8 ${showMoreProducts ? 'mt-6 sm:mt-10' : 'mt-4 sm:mt-6'} lg:mt-0 lg:z-50`} data-aos="fade-left" data-aos-delay="200">
